...
class ReminderMailer < Mailer
  ...
  def self.due_date_notifications
    Rails.logger.info '*********self.due_date_notifications start***************'
    ...
    Rails.logger.info '*********self.due_date_notifications end***************'
  end

  def due_date_notification(user, projects)
    Rails.logger.info '*********due_date_notifications start***************'
    ...
    Rails.logger.info '*********due_date_notifications end***************'
  end
